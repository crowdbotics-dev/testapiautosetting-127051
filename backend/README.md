...
## Project Structure
    ...
    ├── testapiautosetting_127051  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127051`
...
2. Clone this repo and `cd testapiautosetting_127051`
